...
<body>
    ...
    <form method="POST" action="inputkeluar_staffgudang.php" class="form-small" id="form-input">
    ...
    <div class="center">
        <form method="GET" action="inputbarangkeluar_staffgudang.php" class="mb-3">
        ...
        <table class="table" style="width: 40%; margin-left:30px">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($query)) {
                    ...
                    echo "<td><a class='btn btn-outline-danger' href='inputbarang_keluarhapus.php?id_barang=".$row['id_barang']."'>Hapus</a></td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
