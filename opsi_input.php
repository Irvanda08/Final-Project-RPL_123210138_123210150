      ...
      <div class="mask" style="background-color: rgba(0, 0, 0, 0.6);">
        <div class="d-flex justify-content-center align-items-center h-100">
          <div class="text-white">
            <a class="btn btn-outline-light btn-lg" href="inputbarang_admin.php" role="button">Input Barang Masuk</a>
            <p>(Untuk memasukan barang yang belum di input)</p><br>
            <a class="btn btn-outline-light btn-lg" href="inputbarangkeluar_admin.php" role="button">Input Barang Keluar</a>
