        ...
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center align-items-center h-80">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <h3>Selamat Datang di Laman Login Gudang PT MMM</h3>
                    <form method="POST" action="login_admin_proses.php">
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" name="username_admin" id="form3Example3"
                                class="form-control form-control-lg" placeholder="Enter a valid email address" />
                            <label class="form-label" for="form3Example3">Username</label>
                        </div>
                        <!-- Password input -->
                        <div class="form-outline mb-3">
                            <input type="password" name="password_admin" id="form3Example4"
