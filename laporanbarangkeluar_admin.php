...
if (isset($_GET['period'])) {
    ...
    $query .= " ORDER BY waktu_inputklr DESC";

    $result = mysqli_query($connect, $query) or die(mysqli_error($connect));
} else {
    // Jika tidak ada parameter periode, tampilkan semua data barang keluar
...
<head>
    ...
    <title>Laporan Admin Barang Keluar</title>
    ...
    <header>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarExample01">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="inputbarang_admin.php">Input Barang</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            ...
            <div class="judul" style="color: #ffffff;">
                <center>
                    <h1>Data Barang Keluar</h1><br>
                    <button type='button' class='btn btn-outline-primary'><a style="color: #ffffff;"
                            href="laporan_admin.php">Laporan barang Masuk</a></button>
                </center><br>
            </div>
            <table>
                <thead>
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        <td><?php echo $row['id_barangklr']; ?></td>
                        <td><?php echo $row['nama_barangklr']; ?></td>
                        <td><?php echo $row['jenis_barangklr']; ?></td>
                        <td><?php echo $row['harga_barangklr']; ?></td>
                        <td><?php echo $row['ukuran_barangklr']; ?></td>
                        <td><?php echo $row['stok_barangklr']; ?></td>
                        <td><?php echo $row['waktu_inputklr'];?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
            <center><br>
            <button type="button" class="btn btn-outline-primary"><a style="color: #ffffff;"
                    href="laporan_barang_keluar.php" target="_blank">Lihat PDF</a></button></center>
</body>
