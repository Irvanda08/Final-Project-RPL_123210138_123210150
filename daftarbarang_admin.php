...
<body>
    <header>
        ...
        <!-- Navbar -->
        <div class="center">
            <form method="GET" action="daftarbarang_admin.php" class="mb-3">
            ...
            <div class="table-responsive">
                ...
                while ($row = mysqli_fetch_assoc($query)) {
                    ...
                    echo "<td><a class='btn btn-outline-primary' href='daftarbarang_edit.php?id_barang=".$row['id_barang']."'>Ubah</a></td>";
                    echo "<td><a class='btn btn-outline-danger' href='daftarbarang_hapus.php?id_barang=".$row['id_barang']."'>Hapus</a></td>";
                    echo "</tr>";
                }
                ?>
                    </tbody>
